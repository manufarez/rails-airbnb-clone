...
user2 = User.create(username: "Joffrey", city: "Cazalbou", email: "joffrey.cazalbou@gmail.com", password: "jclewagon" )
user3 = User.create(username: "Nathan", city: "Londres", email: "nathan.reix@gmail.com", password: "nrlewagon" )
user4 = User.create(username: "Francis", city: "Paris", email: "francis.berger@gmail.com", password: "fblewagon" )
...
user5 = User.create(username: "random", city: "Paris", email: "random.random@gmail.com", password: "rrlewagon" )
user6 = User.create(username: "random1", city: "Paris", email: "random1.random1@gmail.com", password: "rr1lewagon" )
...
sozee4 = Sozee.new(sozee_name: "Céline Dion", description: "blablablaaaaa bla bla blaaa blaaaaa", category: "Chanteur", price_per_hour: 1000, user: user4)
sozee5 = Sozee.new(sozee_name: "François Hollande", description: "Parce qu'il faut toujours un représentant politique dans vos cocktails dinatoires", category: "Politique", price_per_hour: 100, user: user5)
...
sozee4.remote_photo_url = 'http://www.starway-agency.com/flo/album1photo1.jpg'
sozee5.remote_photo_url = 'http://www.tribunejuive.info/wp-content/uploads/2017/04/sosie-macron.jpg'
